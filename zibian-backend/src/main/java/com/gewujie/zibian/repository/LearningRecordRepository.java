...
public interface LearningRecordRepository extends JpaRepository<LearningRecord, Long> {
    ...
    long countByUserIdAndLearnedAtAfterAndIsGameTrue(Long userId, LocalDateTime date);

    long countByUserIdAndLearnedAtAfterAndIsGameFalse(Long userId, LocalDateTime date);
